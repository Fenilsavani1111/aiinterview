...
const App: React.FC = () => {
  ...
  const handleModalSubmit = async (
    ...
    try {
      ...
      if (error?.response?.data?.studentNotFound) {
        setShowModal(false);
  ...
  const askNextQuestion = useCallback(
    async (currentSession: InterviewSession) => {
      ...
      const questionObj =
        interviewQuestions[currentSession.currentQuestionIndex];
          ...
          <>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                🎤 <strong>Smart Voice Detection!</strong> AI physics interview
                that understands when you're speaking. Answer questions
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 mb-6">
                      🎤 <strong>Intelligent Voice Detection!</strong> The
                      system understands when you're speaking. Answer{" "}
                      {interviewQuestions.length} questions naturally.
                      <br />
                      <br />
                      <strong>
                        Speak at your own pace - no rushing needed!
                      </strong>
                    </p>
                    ...
                    <button
                      ...
                      disabled={
                        !isSupported || !!speechError || !microphoneReady
                      }
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            ...
                            style={{
                              width: `${Math.min(100, voiceActivity)}%`,
                            }}
                          ></div>
                        </div>
                      </div>
