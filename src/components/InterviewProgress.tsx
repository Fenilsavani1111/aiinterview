...
export const InterviewProgress: React.FC<InterviewProgressProps> = ({ session, totalQuestions }) => {
  const progressPercentage = (session.currentQuestionIndex / totalQuestions) * 100;
  ...
  return (
    <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-semibold text-gray-800">Interview Progress</h2>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-blue-50 rounded-xl text-center">
            ...
            <div className="text-2xl font-bold text-blue-800">{elapsedTime}</div>
          ...
          <div className="p-4 bg-purple-50 rounded-xl text-center">
            ...
            <div className="text-2xl font-bold text-purple-800">{session.questions.length}</div>
